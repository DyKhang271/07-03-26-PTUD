      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          ...
          <button
            onClick={onConfirm}
            className="btn"
            style={{ flex: 1, justifyContent: 'center', background: 'var(--danger)', color: 'white' }}
          >
    ...
    <div className="container">
      ...
      <div className="card">
        <div className="toolbar">
          <h2 style={{ margin: 0, fontSize: '1.2rem' }}>Student List</h2>
          <div style={{ display: 'flex', gap: '12px' }}>
              ...
              {loading ? (
                <tr>
                  <td colSpan="5" style={{ textAlign: 'center', padding: '40px', color: 'var(--text-muted)' }}>
                    <i className="fa-solid fa-spinner fa-spin" style={{ fontSize: '32px', marginBottom: '10px', display: 'block' }}></i>
                    Loading...
                  </td>
                </tr>
              ) : students.length === 0 ? (
                    ...
                    <td>
                      <div className="action-btns" style={{ justifyContent: 'flex-end', gap: '10px' }}>
                        ...
                        <button
                          ...
                          className="btn btn-outline"
                          style={{
                            padding: '6px 10px', fontSize: '12px', height: 'auto',
